...
void constructSTUtil(char arr[], int ss, int se, int *st, int si)
{
    ...
    st[si] =  binary_decimal(constructSTUtil(arr, ss, mid, st, si*2+1) + constructSTUtil(arr, mid+1, se, st, si*2+2));
    return ;
}
